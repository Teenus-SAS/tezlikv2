            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        return `
                          <a href="javascript:;" <i id="${data}" class="bx bx-edit-alt updateCompany" data-toggle='tooltip' title='Actualizar Empresa' style="font-size: 30px;"></i></a>
