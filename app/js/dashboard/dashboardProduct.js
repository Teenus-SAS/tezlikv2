...
$(document).ready(function() {
    ...
    fetch(`/api/dashboardPricesProducts/${id_product}`)
        ...
        .then(data => {
            ...
            const indicators = dataProduct[0]
            ...
            const myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [indicators.cost_workforce, indicators.cost_materials, indicators.cost_indirect_cost, indicators.cost_assignable_expense],
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)',
                            'rgba(255, 206, 86, 0.2)',
