            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        <a href="javascript:;" <i id="${data}" class="mdi mdi-delete-forever deleteFactoryLoad" data-toggle='tooltip' title='Eliminar Carga Fabril' style="font-size: 30px;color:red"></i></a>`
                    },
                },
            ],
        }) 
