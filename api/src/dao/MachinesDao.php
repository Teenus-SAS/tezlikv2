...
class MachinesDao
{
  ...
  public function insertMachinesByCompany($dataMachine, $id_company)
  {
    ...
    try {
      $stmt = $connection->prepare("INSERT INTO machines (machine, cost, years_depreciation, minute_depreciation) 
                                    VALUES(:machine, :cost, :years_depreciation, :minute_depreciation)");
      $stmt->execute([
