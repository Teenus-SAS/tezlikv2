...
$app->post('/updateCompanyUsersStatus', function (Request $request, Response $response, $args) use ($companyUsers) {
    $dataUser = $request->getParsedBody();
    $status = $companyUsers->updateCompanyUsersStatus($dataUser);
